...
from smartlingApiSdk.AccountProjectsApiAutoGenerated import AccountProjectsApiAuto
...
class testProjetcsV2(object):
    ...
    def setUp(self):
        ...
        if useProxy :
            ...
            proxySettings = None        
        self.papi = AccountProjectsApiAuto(self.MY_USER_IDENTIFIER, self.MY_USER_SECRET, self.MY_PROJECT_ID, proxySettings)
