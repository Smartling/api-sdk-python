...
from smartlingApiSdk.FileApiAutoGenerated import FilesApiAuto
...
class SmartlingApiExample:
    ...
    def __init__(self, file_name, file_type, new_name):
        ...
        self.fapi = FilesApiAuto( self.MY_USER_IDENTIFIER, self.MY_USER_SECRET, self.MY_PROJECT_ID, proxySettings)
